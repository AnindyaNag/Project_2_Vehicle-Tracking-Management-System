		    ...
		    <div class="modal-content">
		      ...
		      <form action="" method="POST" enctype="multipart/form-data">
			      <div class="modal-body">
			      	<label for="User-mail"><b>Device Name_Device No.</b></label>
			      	<input type="text" name="dev_name" id="dev_name" placeholder="Device Name_Device No..." required/><br>
			      	<label for="User-mail"><b>Gate No.:</b></label>
			      	<input type="text" name="dev_dep" id="dev_dep" placeholder="Gate No...." required/><br>
			      </div>
