...
<div class="header">
	<div class="logo">
		<a href="index.php">Vehicle Tracking Management System</a>
	</div>
</div>
<?php  
  if (isset($_GET['error'])) {
...
<div class="topnav" id="myTopnav">
	<a href="index.php">All Vehicles</a>
    <a href="ManageUsers.php">Manage Vehicles</a>
    <a href="UsersLog.php">Vehicles Log</a>
